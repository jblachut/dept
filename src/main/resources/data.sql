...
(1, 'USER', 't1@email.com', 'Wojciech', 'Musial', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2'),

(2, 'ADMIN', 't2@email.com', 'Marcin', 'Kowalski', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2'),

(3, 'USER',  't3@email.com', 'USER','Marek', 'Marecki', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2'),

(4, 'USER', 't4@email.com', 'USER', 'Zbigniew', 'Nowak', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2'),

(5, 'USER', 't5@email.com', 'USER','Sylwia', 'Wisniewska', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2'),

(6, 'USER', 't6@email.com', 'USER', 'Klaudia', 'Kowalska', '$2a$10$bUhiQH1IVW4HeGGJVxPFFeTXPPsD5p2uhmjkMR/nuSy6uRpcd4OH2');
